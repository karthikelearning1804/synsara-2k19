        ...
        var width,
            ...
            _Functions = {
                initContainer: function () {
                    ...
                    // canvas.style.backgroundColor = colorHexCode.synsara;
                    // canvas.style.backgroundImage = "url('./js/background/test.jpg')";
                    //  = url("./team.png");
                    ...
                    // }
                    points = [];
                    for (var x = 0; x < width * 2; x = x + width / 5) {
                        for (var y = 0; y < height * 2; y = y + height / 5) {
                            var px = x + Math.random() * width / 3;
                            var py = y + Math.random() * height / 3;
                            var p = {
                                x: px,
